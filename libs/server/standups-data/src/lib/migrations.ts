...
export const MIGRATION_0000_SQL = `
...
CREATE UNIQUE INDEX IF NOT EXISTS standups_source_message_unique ON standups(source, source_message_id);
...
export function applyMigrations(sqlite: Database.Database): void {
  ...
  sqlite.transaction(() => {
    sqlite.exec(MIGRATION_0000_SQL);
