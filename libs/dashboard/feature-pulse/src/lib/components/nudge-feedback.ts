...
@Component({
  selector: 'lib-pulse-nudge-feedback',
  imports: [NgIcon],
  changeDetection: ChangeDetectionStrategy.OnPush,
  template: `
    @if (store.isNudging()) {
      <div class="toast toast-top toast-end pulse-toast" aria-live="polite">
      ...
      <div class="toast toast-top toast-end pulse-toast" aria-live="assertive">
